              ...
              completion:(void(^) (BOOL cancelled))completion
{
    ...
    if (self) {
        ...
        _alertWindow = [self windowWithLevel:UIWindowLevelNormal];
        if (!_alertWindow) {
        ...
        _alertView.backgroundColor = [UIColor colorWithRed:246/255.0 green:246/255.0 blue:246/255.0 alpha:1];
        ...
        _titleLabel.textColor = [UIColor colorWithRed:21/255.0 green:21/255.0 blue:21/255.0 alpha:1];
        ...
        CGFloat messageLabelY = _titleLabel.frame.origin.y + _titleLabel.frame.size.height + AlertViewVerticalElementSpace+2;
        ...
        _messageLabel.textColor = [UIColor colorWithRed:21/255.0 green:21/255.0 blue:21/255.0 alpha:1];
        ...
        lineLayer.backgroundColor = [[UIColor colorWithRed:199/255.0 green:199/255.0 blue:199/255.0 alpha:1] CGColor];
        ...
        [_cancelButton setTitleColor:[UIColor colorWithRed:25/255.0 green:116/255.0 blue:254/255.0 alpha:1] forState:UIControlStateNormal];
        ...
        if (otherTitle) {
            ...
            [_otherButton setTitleColor:[UIColor colorWithRed:21/255.0 green:114/255.0 blue:255/255.0 alpha:1] forState:UIControlStateNormal];
...
{
    [sender setBackgroundColor:[UIColor colorWithRed:208/255.0 green:208/255.0 blue:208/255.0 alpha:1.0]];
}
    ...
    if (floor(NSFoundationVersionNumber) <= 993.00) {
        ...
        /*CGRect bounds = [label.text boundingRectWithSize:CGSizeMake(label.frame.size.width, FLT_MAX)
                                     ...
                                     attributes:@{NSFontAttributeName:label.font}
                                        context:context];*/
        CGSize bound = [label.text sizeWithFont:label.font constrainedToSize:CGSizeMake(label.frame.size.width, FLT_MAX)];
        height = bound.height;
    }
