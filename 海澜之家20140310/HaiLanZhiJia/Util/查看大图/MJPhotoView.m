...
- (void)adjustFrame
{
    ...
    CGRect imageFrame = CGRectMake(0, 0, boundsWidth, imageHeight * boundsWidth / imageWidth*self.maximumZoomScale);
    // 内容尺寸
...
//{
//    NSLog(@"%@ %f",view,scale);
//    CGRect imageFrame = CGRectMake(0, 0, self.bounds.size.width, _imageView.image.size.height * (self.bounds.size.width / _imageView.image.size.width)*scale);
//    // 内容尺寸
//    self.contentSize = CGSizeMake(0, imageFrame.size.height);
//    // y值
